  ...
  return (
    <div className="relative" ref={containerRef}>
      <button
        ...
        } rounded-xl text-slate-900 dark:text-white font-medium transition-all hover:border-blue-500/50 flex items-center justify-between group outline-none`}
      >
      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="absolute top-full left-0 right-0 mt-2 bg-white dark:bg-[#0f172a] border border-slate-100 dark:border-white/10 rounded-xl shadow-2xl overflow-hidden z-50 max-h-60 overflow-y-auto custom-scrollbar"
          >
            {options.map((option) => (
              <button
                key={option.value}
...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-slate-50 dark:bg-[#020617] dark:bg-[radial-gradient(ellipse_at_top,_var(--tw-gradient-stops))] dark:from-blue-900/40 dark:via-[#020617] dark:to-[#020617] text-slate-900 dark:text-white font-sans selection:bg-red-600 selection:text-white relative transition-colors duration-300">
      {/* Noise Overlay */}
      <div 
      ...
      {/* Navigation */}
      <nav className="fixed top-0 left-0 w-full z-[100] transition-all duration-500 ease-in-out translate-y-0 bg-white/95 dark:bg-[#020617]/90 backdrop-blur-md py-4 border-b border-slate-200 dark:border-white/5 shadow-2xl">
      ...
      {/* Mobile Menu */}
      <div
        className={`fixed inset-0 z-[200] bg-slate-50 dark:bg-[#020617] transition-transform duration-500 transform ${
      ...
      <section className="relative pt-32 md:pt-40 pb-32 md:pb-48 px-4 sm:px-6">
        <div className="w-full md:max-w-7xl mx-auto relative z-40">
          ...
          <div className="absolute bottom-0 left-1/2 -translate-x-1/2 translate-y-1/2 w-[90%] max-w-5xl bg-slate-50 dark:bg-[#0f172a]/95 backdrop-blur-xl rounded-3xl shadow-2xl border border-slate-200 dark:border-blue-900/30 p-8 md:p-10 animate-in fade-in zoom-in duration-700 delay-500 z-40">
      ...
      <section id="unidades" className="relative z-30 pt-64 pb-32 bg-white dark:bg-transparent">
        <FadeIn className="max-w-7xl mx-auto px-6">
          ...
          <div className="group relative bg-slate-50 dark:bg-[#0f172a] rounded-[40px] overflow-hidden border border-slate-200 dark:border-white/5 hover:border-red-600/30 transition-all duration-500 shadow-2xl flex flex-col md:flex-row">
            ...
            <div className="p-10 md:w-1/2 flex flex-col justify-center">
              <h3 className="text-3xl font-black italic uppercase tracking-tighter mb-6 text-slate-900 dark:text-white group-hover:text-red-500 transition-colors">
                Águas Lindas
              </h3>
        ...
        <FadeIn className="max-w-7xl mx-auto px-6 relative z-10">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              <div
                key={index}
                className="group relative bg-slate-50 dark:bg-white/10 backdrop-blur-lg rounded-[32px] p-8 border border-slate-200 dark:border-white/10 hover:border-red-600/30 dark:hover:border-white/20 transition-all duration-500 flex flex-col shadow-xl"
              >
                <div className="absolute top-8 right-8 text-slate-200 dark:text-white/5 group-hover:text-red-600/10 dark:group-hover:text-red-600/20 transition-colors duration-500">
                ...
                <div className="flex items-center gap-4 mb-8">
                  <div className="relative">
                    <img
                      ...
                      src={review.img}
                    />
                    <div className="absolute -bottom-1 -right-1 bg-red-500 rounded-full p-1 border-2 border-white dark:border-neutral-900">
                ...
                <div className="pt-6 border-t border-slate-200 dark:border-white/5 flex items-center justify-between">
                  ...
                  <ExternalLink className="w-3.5 h-3.5 text-slate-400 dark:text-gray-500 group-hover:text-red-600 dark:group-hover:text-white transition-colors" />
                </div>
              </div>
            ))}
          </div>
            ...
            {[
              ...
              <div
                ...
                className={`group border rounded-2xl overflow-hidden transition-all duration-300 ${
                  openFaqIndex === index
                    ? 'bg-white dark:bg-[#0f172a] border-red-500 dark:border-red-500 shadow-[0_0_20px_rgba(239,68,68,0.15)]'
                    : 'bg-white dark:bg-[#0f172a]/50 border-slate-200 dark:border-white/5 hover:border-red-500/30'
                }`}
              >
                <button
                ...
                >
                  ...
                  <div className={`relative flex items-center justify-center w-8 h-8 rounded-full transition-all duration-300 ${
                    openFaqIndex === index 
                      ...
                      : 'bg-slate-100 dark:bg-white/5 group-hover:bg-red-50 dark:group-hover:bg-red-900/20'
                  }`}>
                    <ChevronDown
                      className={`w-5 h-5 transition-colors duration-300 ${
                        openFaqIndex === index 
                          ? 'text-red-600 dark:text-red-400' 
                          : 'text-slate-500 dark:text-white group-hover:text-red-600 dark:group-hover:text-red-400'
                      }`}
                    />
                  </div>
                </button>
      ...
      {/* Footer */}
      <footer className="bg-neutral-900 dark:bg-[#000000] pt-32 pb-32 md:pb-12 border-t border-neutral-800 relative overflow-hidden transition-colors duration-300">
        {/* Background Image */}
