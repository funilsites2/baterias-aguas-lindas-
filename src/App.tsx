  ...
  return (
    <div className="relative" ref={containerRef}>
      <button
        ...
        className={`w-full pl-12 pr-4 py-4 text-left bg-white border ${
          isOpen ? 'border-blue-500 ring-2 ring-blue-500/20' : 'border-slate-200'
        } rounded-xl text-slate-900 font-medium transition-all hover:border-blue-500/50 flex items-center justify-between group outline-none`}
      >
        <div className="absolute left-4 text-slate-400 group-hover:text-red-600 transition-colors">
      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="absolute top-full left-0 right-0 mt-2 bg-white border border-slate-100 rounded-xl shadow-2xl overflow-hidden z-50 max-h-60 overflow-y-auto custom-scrollbar"
          >
            {options.map((option) => (
              <button
                key={option.value}
...
export default function App() {
  ...
  const cityOptions = [
    { value: 'jardim-brasilia', label: 'Jardim Brasília' },
    { value: 'parque-da-barragem', label: 'Parque da Barragem' },
    { value: 'camping-clube', label: 'Camping Clube' },
    { value: 'mansoes-odisseia', label: 'Mansões Odisséia' },
    { value: 'setor-perola', label: 'Setor Pérola' },
  ...
  const defaultWhatsappUrl = `https://wa.me/5561998688643?text=${defaultWhatsappMessage}`;

  const getWhatsappLink = () => {
    const phoneNumber = '5561998688643';
    let message = 'Olá, gostaria de conferir os preços';
    
    const cityMap: Record<string, string> = {
      'jardim-brasilia': 'Jardim Brasília',
      'parque-da-barragem': 'Parque da Barragem',
      'camping-clube': 'Camping Clube',
      'mansoes-odisseia': 'Mansões Odisséia',
      'setor-perola': 'Setor Pérola',
  ...
  return (
    <div className="min-h-screen bg-slate-50 text-slate-900 font-sans selection:bg-red-600 selection:text-white relative transition-colors duration-300">
      {/* Noise Overlay */}
      <div 
      ...
      >
        <div className="flex items-center justify-center gap-3 bg-[#25D366] py-5 md:py-4 md:px-6 md:rounded-full shadow-2xl hover:bg-[#20ba5a] transition-all group hover-electric-red">
      ...
      {/* Navigation */}
      <nav className="fixed top-0 left-0 w-full z-[100] transition-all duration-500 ease-in-out translate-y-0 bg-white/95 backdrop-blur-md py-4 border-b border-slate-200 shadow-2xl">
        <div className="max-w-7xl mx-auto px-6 flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center gap-8 text-xs font-bold tracking-widest text-slate-600">
            <a href="#" className="hover:text-red-500 transition-colors uppercase">
              Início
            </a>
            <a
              href="#produtos"
          ...
          <div className="hidden md:flex items-center gap-4">
            <a
              id="btn-header-call"
              href="tel:61998688643"
              className="flex items-center gap-2 text-white bg-red-600 px-6 py-2.5 rounded-full text-[10px] font-black uppercase tracking-widest hover:bg-white hover:text-red-600 transition-all duration-300 shadow-lg shadow-red-600/20 border border-transparent hover:border-red-600 hover-electric-red"
            >
              <Phone className="w-3.5 h-3.5" /> Deseja Pedir por Telefone? Ligue: 61998688643
            </a>
          </div>
      ...
      {/* Mobile Menu */}
      <div
        className={`fixed inset-0 z-[200] bg-slate-50 transition-transform duration-500 transform ${
        ...
        <div className="p-6 flex flex-col h-full">
          <div className="flex justify-between items-center mb-12">
            ...
            <button
              ...
              className="p-2 border border-slate-200 rounded-full text-slate-900 cursor-pointer"
            >
              <X className="w-7 h-7" />
            </button>
          </div>
          <div className="flex flex-col gap-8 text-4xl font-black italic tracking-tighter text-slate-900">
      ...
      <section className="relative pt-24 md:pt-28 pb-32 md:pb-48">
        <div className="w-full relative z-40">
          ...
          <div className="absolute bottom-0 left-1/2 -translate-x-1/2 translate-y-1/2 w-[90%] max-w-5xl bg-slate-50 backdrop-blur-xl rounded-3xl shadow-2xl border border-slate-200 p-8 md:p-10 animate-in fade-in zoom-in duration-700 delay-500 z-40">
            <h2 className="text-center text-xl md:text-2xl font-black italic tracking-tight text-slate-900 mb-8">
            ...
            <div className="grid md:grid-cols-3 gap-6">
              ...
              <a 
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center justify-center gap-2 bg-red-600 text-white font-black uppercase tracking-widest py-4 rounded-xl hover:bg-red-700 transition-all shadow-lg shadow-red-600/20 hover-electric-red"
              >
                Confira os preços
              </a>
            </div>
        ...
        <FadeIn className="max-w-7xl mx-auto px-6">
          <div className="mb-20">
            <div className="flex items-center gap-2 text-red-600 font-bold text-xs tracking-[0.4em] mb-4 uppercase">
              <span className="w-8 h-[2px] bg-red-600"></span>Onde Estamos
            </div>
            <h2 className="text-3xl md:text-6xl font-black tracking-tighter uppercase italic text-slate-900">
              Nossas Unidades
            </h2>
          </div>
          <div className="group relative bg-slate-50 rounded-[40px] overflow-hidden border border-slate-200 hover:border-red-600/30 transition-all duration-500 shadow-2xl flex flex-col md:flex-row">
            <div className="w-full md:w-1/2 aspect-square relative overflow-hidden">
              ...
              <div className="absolute top-6 left-6 bg-red-600 text-white px-4 py-1 rounded-full text-[10px] font-black uppercase tracking-widest">
                Loja Física
              </div>
            </div>
            <div className="p-10 md:w-1/2 flex flex-col justify-center">
              <h3 className="text-3xl font-black italic uppercase tracking-tighter mb-6 text-slate-900 group-hover:text-red-500 transition-colors">
                Águas Lindas
              </h3>
              <div className="space-y-6 mb-10">
                <div className="flex items-start gap-4">
                  ...
                  <p className="text-slate-600 text-sm font-medium leading-relaxed">
                    Av. Tancredo Neves, Loja 2, do Lote 2, da Quadra 70 Bairro Cidade Jardim,<br />Águas Lindas de Goiás
                  </p>
                </div>
              ...
              <div className="grid grid-cols-2 gap-4">
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex items-center justify-center gap-2 py-4 bg-slate-200 border border-slate-300 rounded-2xl text-[10px] font-black uppercase tracking-widest text-slate-900 hover:bg-slate-900 hover:text-white transition-all"
                >
                  <MapPin className="w-3.5 h-3.5" /> Ver Mapa
                </a>
                <a
                  id="btn-aguas-lindas-whatsapp"
                  href={defaultWhatsappUrl}
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex items-center justify-center gap-2 py-4 bg-red-600 text-white rounded-2xl text-[10px] font-black uppercase tracking-widest hover:bg-red-700 transition-all shadow-lg shadow-red-600/20 hover-electric-red"
                >
      ...
      <section id="produtos" className="relative z-30 py-32 bg-white">
        <FadeIn className="max-w-7xl mx-auto px-6">
          <div className="mb-16">
            <h2 className="text-3xl md:text-5xl font-black italic uppercase text-slate-900 mb-4">
          ...
          <div className="grid md:grid-cols-3 gap-12 mb-20">
            <div className="flex gap-6">
              <div className="shrink-0">
                <Award className="w-12 h-12 text-blue-500" strokeWidth={1.5} />
              </div>
              <div>
            ...
            <div className="flex gap-6">
              <div className="shrink-0">
                <div className="relative">
                  ...
                  <Zap className="w-5 h-5 text-blue-500 absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 fill-current" />
                </div>
              </div>
              <div>
                <h3 className="text-xl font-black uppercase text-slate-900 mb-2">
            ...
            <div className="flex gap-6">
              <div className="shrink-0">
                <ThumbsUp className="w-12 h-12 text-blue-500" strokeWidth={1.5} />
              </div>
              <div>
                <h3 className="text-xl font-black uppercase text-slate-900 mb-2">
          ...
          <div className="relative w-full aspect-[21/9] md:aspect-[3/1] bg-gradient-to-b from-transparent to-slate-50 rounded-3xl flex items-end justify-center overflow-hidden">
            <img 
      ...
      <section
        id="depoimentos"
        className="relative z-30 py-32 bg-white overflow-hidden"
      >
        ...
        <FadeIn className="max-w-7xl mx-auto px-6 relative z-10">
          <div className="text-center mb-20">
            <div className="flex items-center justify-center gap-2 text-red-600 font-bold text-xs tracking-[0.4em] mb-4 uppercase">
              <span className="w-8 h-[2px] bg-red-600"></span>O que dizem sobre
              nós<span className="w-8 h-[2px] bg-red-600"></span>
            </div>
            <h2 className="text-3xl md:text-7xl font-black tracking-tighter italic uppercase mb-6 text-slate-900">
              Avaliações reais
            </h2>
            <div className="inline-flex items-center gap-4 bg-slate-100 backdrop-blur-md px-6 py-3 rounded-full border border-slate-200">
              <div className="flex text-yellow-500 gap-1">
                {[...Array(5)].map((_, i) => (
                  <Star key={i} className="w-5 h-5 fill-current" />
                ))}
              </div>
              <span className="text-xl font-black italic tracking-tight text-slate-900">
                5.0 / 5 no Google
              </span>
            </div>
          </div>
            ...
            {[
              {
                name: 'Carlos Almeida',
                time: 'há 3 dias',
                text: '"Serviço muito rápido e profissional aqui em Águas Lindas. Salvaram meu dia quando o carro não pegou na garagem de casa antes de ir pro trabalho!"',
              ...
              },
              {
                name: 'Roberto Souza',
                time: 'há 1 mês',
                text: '"Melhor loja de baterias da região. Preço justo e vieram até o Jardim Brasília para trocar a minha. Fizeram todos os testes no meu carro, nota 10!"',
                img: 'https://randomuser.me/api/portraits/men/75.jpg',
              },
            ].map((review, index) => (
              <div
                key={index}
                className="group relative bg-slate-50 backdrop-blur-lg rounded-[32px] p-8 border border-slate-200 hover:border-red-600/30 transition-all duration-500 flex flex-col shadow-xl"
              >
                <div className="absolute top-8 right-8 text-slate-200 group-hover:text-red-600/10 transition-colors duration-500">
                ...
                <div className="flex items-center gap-4 mb-8">
                  ...
                  <div>
                    <h4 className="font-black text-lg italic uppercase tracking-tighter leading-none mb-1 text-slate-900">
                      {review.name}
                    </h4>
                ...
                <p className="text-slate-600 text-sm leading-relaxed font-medium mb-8 flex-grow">
                  {review.text}
                </p>
      ...
      <section
        id="faq"
        className="relative z-30 py-32 bg-slate-50 border-y border-slate-200"
      >
        <FadeIn className="max-w-4xl mx-auto px-6">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-5xl font-black tracking-tighter italic uppercase text-slate-900">
            ...
            {[
              ...
              <div
                ...
                className={`group border rounded-2xl overflow-hidden transition-all duration-300 ${
                  openFaqIndex === index
                    ? 'bg-white border-red-500 shadow-[0_0_20px_rgba(239,68,68,0.15)]'
                  ...
                  {openFaqIndex === index && (
                    ...
                    >
                      <div className="p-6 pt-0">
                        <div className="h-px w-full bg-gradient-to-r from-transparent via-red-500/20 to-transparent mb-4"></div>
                        <p className="text-slate-600 leading-relaxed">
                          {item.a}
                        </p>
                      </div>
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10">
          <div className="grid md:grid-cols-4 gap-16 mb-24">
            <div className="col-span-1">
              ...
              <a
                href="tel:61998688643"
                className="hidden md:inline-flex items-center gap-2 text-white bg-red-600 px-6 py-3 rounded-full text-[10px] font-black uppercase tracking-widest hover:bg-white hover:text-red-600 transition-all shadow-lg shadow-red-600/20 hover-electric-red"
              >
                <Phone className="w-3.5 h-3.5" /> Deseja Pedir por Telefone? Ligue: 61998688643
              </a>
            </div>
            <div>
              <h4 className="font-black mb-10 uppercase tracking-[0.3em] text-[10px] text-red-500 italic">
                Serviços
              </h4>
            ...
            <div>
              ...
              <div className="flex gap-4">
                <div className="bg-neutral-800 border border-neutral-700 p-3 rounded-2xl hover:bg-blue-600 hover:text-white transition-all cursor-pointer text-neutral-400">
